...
* As a "Software Engineer" You are to create a "Technical Report" for the business execs
...
* Each feature should contain
    ...
    2. A code block snippet example demonstrating the feature 
        ...
        * If you should additionally 'permalink' to athe snippet in your own code from assignment1
